...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"01.05.2024-Sturmschäden.mdx": {
	id: "01.05.2024-Sturmschäden.mdx";
  slug: "01052024-sturmschäden";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
"03.10.2024-Baumpflege.mdx": {
	id: "03.10.2024-Baumpflege.mdx";
  slug: "03102024-baumpflege";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
